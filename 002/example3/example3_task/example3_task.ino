...
int pins[4] = {0, 1, 2, 3}; //eiioaeoe 0, 1, 2, 3, ia ieao? Arduino
//eiioaeoe D0, D1, D2, D3 aaeiaa? 74LS49
// cia?aiiy aey aeaiao oeo? 0-9
byte numbers[10] = { 
0b0000, 0b1000, 0b0100, 0b1100, 0b0010, // 0, 1, 2, 3, 4,
0b1010, 0b0110, 0b1110, 0b0001, 0b1001};  // 5, 6, 7, 8, 9
// ci?iia aey caa?a?aiiy cia?aiiy iioi?ii? oeo?e
...
void setup()
{
	...
	pinMode(9, OUTPUT); 
	pinMode(8, OUTPUT);
	//digitalWrite(9, LOW); //aey aee??aiiy aaeiaa?a
	//digitalWrite(8, LOW);
}
void loop() {
...
void showNumber(int num)
{
	for (int i = 0; i < 4; i++)
	{
		if (bitRead(numbers[num], 3 - i) == HIGH) {	// aee. naaiaio
